...
class Experiment(object):
    ...
    def prepare(self):
        ...
        self.workload_generator = WorkloadGenerator(
            ...
            workload_tables=self.schema.tables,
        ...
        if "workload_embedder" in self.config:
            workload_embedder_class = getattr(
                importlib.import_module("SWPRL.workload_embedder"), self.config["workload_embedder"]["type"]
            )
    ...
    def _evaluate_comparison(self):
        for key, comparison_indexes in self.comparison_indexes.items():
            ...
            impossible_index_columns = columns_from_indexes - self.globally_partitionable_columns_flat
